...
export class OrderInitialResponseObjectOrderInitialResponse {
    /**
    ...
    */
    'responseActions': Array<OrderInitialResponseObjectOrderInitialResponse.ResponseActionsEnum>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "Array<OrderInitialResponseObjectOrderInitialResponse.ResponseActionsEnum>"
        },
        {
    ...
    static getAttributeTypeMap() {
        return OrderInitialResponseObjectOrderInitialResponse.attributeTypeMap;
    }
}

export namespace OrderInitialResponseObjectOrderInitialResponse {
