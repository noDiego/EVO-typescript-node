...
exports.KeysRenewalObjectKeysRenewal = void 0;
var KeysRenewalObjectKeysRenewal = /** @class */ (function () {
    function KeysRenewalObjectKeysRenewal() {
    }
    KeysRenewalObjectKeysRenewal.getAttributeTypeMap = function () {
        return KeysRenewalObjectKeysRenewal.attributeTypeMap;
    };
    KeysRenewalObjectKeysRenewal.discriminator = undefined;
    KeysRenewalObjectKeysRenewal.attributeTypeMap = [
        {
    ...
    return KeysRenewalObjectKeysRenewal;
}());
exports.KeysRenewalObjectKeysRenewal = KeysRenewalObjectKeysRenewal;
