...
export class BlockCreateObjectBlockCreate {
    /**
    ...
    */
    'reasonSequenceBreak'?: BlockCreateObjectBlockCreate.ReasonSequenceBreakEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "BlockCreateObjectBlockCreate.ReasonSequenceBreakEnum"
        },
        {
            "name": "pOSType",
            "baseName": "POSType",
    ...
    static getAttributeTypeMap() {
        return BlockCreateObjectBlockCreate.attributeTypeMap;
    }
}

export namespace BlockCreateObjectBlockCreate {
