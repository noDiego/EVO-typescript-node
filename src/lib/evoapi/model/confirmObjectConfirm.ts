...
export class ConfirmObjectConfirm {
    /**
    ...
    */
    'reasonSequenceBreak'?: ConfirmObjectConfirm.ReasonSequenceBreakEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ConfirmObjectConfirm.ReasonSequenceBreakEnum"
        },
        {
            "name": "pOSType",
            "baseName": "POSType",
    ...
    static getAttributeTypeMap() {
        return ConfirmObjectConfirm.attributeTypeMap;
    }
}

export namespace ConfirmObjectConfirm {
