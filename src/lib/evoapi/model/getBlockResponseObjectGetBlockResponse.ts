...
export class GetBlockResponseObjectGetBlockResponse {
    /**
    ...
    */
    'responseActions': Array<GetBlockResponseObjectGetBlockResponse.ResponseActionsEnum>;
    /**
    ...
    */
    'wasReversePrevious'?: GetBlockResponseObjectGetBlockResponse.WasReversePreviousEnum;
    /**
    * Flag indicador de cancelación o confirmación del último bloque de transacciones, previo al nuevo valor recibido
    */
    'wasClosedPreviousBlock'?: GetBlockResponseObjectGetBlockResponse.WasClosedPreviousBlockEnum;
    /**
...
export namespace GetBlockResponseObjectGetBlockResponse {
