...
* Datos del Cliente
*/
export class SaleObjectSaleCustomer {
    /**
    ...
    */
    'identificationType'?: SaleObjectSaleCustomer.IdentificationTypeEnum;
    /**
    * Email del Cliente
    */
    'email'?: string;
    ...
    * Tipo de documento del Cliente. CI, Cédula de identidad - PAS, Pasaporte, Documento nacional de identidad, Contrato - CONTRACT, Número de Cuenta - ACCOUNT_NUMBER
    */
    'documentType'?: SaleObjectSaleCustomer.DocumentTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "SaleObjectSaleCustomer.IdentificationTypeEnum"
        },
        {
            "name": "email",
            "baseName": "Email",
        ...
        },
        {
            ...
            "type": "SaleObjectSaleCustomer.DocumentTypeEnum"
        },
        {
            "name": "documentNumber",
    ...
    static getAttributeTypeMap() {
        return SaleObjectSaleCustomer.attributeTypeMap;
    }
}

export namespace SaleObjectSaleCustomer {
