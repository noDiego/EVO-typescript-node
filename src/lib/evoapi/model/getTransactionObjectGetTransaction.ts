...
export class GetTransactionObjectGetTransaction {
    /**
    ...
    */
    'reasonSequenceBreak'?: GetTransactionObjectGetTransaction.ReasonSequenceBreakEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "GetTransactionObjectGetTransaction.ReasonSequenceBreakEnum"
        },
        {
            "name": "reference",
            "baseName": "Reference",
    ...
    static getAttributeTypeMap() {
        return GetTransactionObjectGetTransaction.attributeTypeMap;
    }
}

export namespace GetTransactionObjectGetTransaction {
