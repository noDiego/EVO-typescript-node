...
* Datos del Pagador
*/
export class SaleObjectSalePayer {
    /**
    ...
    */
    'identificationType'?: SaleObjectSalePayer.IdentificationTypeEnum;
    /**
    * Email del Pagador
    */
    'email'?: string;
    ...
    * Tipo de documento del Pagador. CI, Cédula de identidad - PAS, Pasaporte, Documento nacional de identidad, Contrato - CONTRACT, Número de Cuenta - ACCOUNT_NUMBER
    */
    'documentType'?: SaleObjectSalePayer.DocumentTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "SaleObjectSalePayer.IdentificationTypeEnum"
        },
        {
            "name": "email",
            "baseName": "Email",
        ...
        },
        {
            ...
            "type": "SaleObjectSalePayer.DocumentTypeEnum"
        },
        {
            "name": "documentNumber",
    ...
    static getAttributeTypeMap() {
        return SaleObjectSalePayer.attributeTypeMap;
    }
}

export namespace SaleObjectSalePayer {
