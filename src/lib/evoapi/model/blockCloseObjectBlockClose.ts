...
export class BlockCloseObjectBlockClose {
    /**
    ...
    */
    'reasonSequenceBreak'?: BlockCloseObjectBlockClose.ReasonSequenceBreakEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "BlockCloseObjectBlockClose.ReasonSequenceBreakEnum"
        },
        {
            "name": "pOSType",
            "baseName": "POSType",
    ...
    static getAttributeTypeMap() {
        return BlockCloseObjectBlockClose.attributeTypeMap;
    }
}

export namespace BlockCloseObjectBlockClose {
