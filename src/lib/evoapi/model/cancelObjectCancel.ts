...
export class CancelObjectCancel {
    /**
    ...
    */
    'reason'?: CancelObjectCancel.ReasonEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "reason",
            "baseName": "Reason",
            "type": "CancelObjectCancel.ReasonEnum"
        },
        {
            "name": "pOSType",
            "baseName": "POSType",
    ...
    static getAttributeTypeMap() {
        return CancelObjectCancel.attributeTypeMap;
    }
}

export namespace CancelObjectCancel {
