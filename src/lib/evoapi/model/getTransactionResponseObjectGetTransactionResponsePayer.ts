...
* Datos del Pagador
*/
export class GetTransactionResponseObjectGetTransactionResponsePayer {
    /**
    ...
    */
    'identificationType'?: GetTransactionResponseObjectGetTransactionResponsePayer.IdentificationTypeEnum;
    /**
    * Email del Pagador
    */
    'email'?: string;
    ...
    * Tipo de documento del Pagador. CI, Cédula de identidad - PAS, Pasaporte, Documento nacional de identidad, Contrato - CONTRACT, Número de Cuenta - ACCOUNT_NUMBER
    */
    'documentType'?: GetTransactionResponseObjectGetTransactionResponsePayer.DocumentTypeEnum;
    /**
    ...
    */
    'currencyCode'?: GetTransactionResponseObjectGetTransactionResponsePayer.CurrencyCodeEnum;
    /**
...
export namespace GetTransactionResponseObjectGetTransactionResponsePayer {
    export enum IdentificationTypeEnum {
        Pas = <any> 'PAS',
        Ci = <any> 'CI',
        AccountNumber = <any> 'ACCOUNT_NUMBER',
