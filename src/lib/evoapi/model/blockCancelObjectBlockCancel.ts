...
export class BlockCancelObjectBlockCancel {
    /**
    ...
    */
    'reasonSequenceBreak'?: BlockCancelObjectBlockCancel.ReasonSequenceBreakEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "BlockCancelObjectBlockCancel.ReasonSequenceBreakEnum"
        },
        {
            "name": "pOSType",
            "baseName": "POSType",
    ...
    static getAttributeTypeMap() {
        return BlockCancelObjectBlockCancel.attributeTypeMap;
    }
}

export namespace BlockCancelObjectBlockCancel {
