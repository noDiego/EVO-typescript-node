...
export class CloseObjectClose {
    ...
    */
    'reasonSequenceBreak'?: CloseObjectClose.ReasonSequenceBreakEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CloseObjectClose.ReasonSequenceBreakEnum"
        },
        {
            "name": "pOSType",
            "baseName": "POSType",
    ...
    static getAttributeTypeMap() {
        return CloseObjectClose.attributeTypeMap;
    }
}

export namespace CloseObjectClose {
