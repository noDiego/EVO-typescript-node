...
exports.QueryLineOfBusinessObjectQueryLineOfBusiness = void 0;
var QueryLineOfBusinessObjectQueryLineOfBusiness = /** @class */ (function () {
    function QueryLineOfBusinessObjectQueryLineOfBusiness() {
    }
    QueryLineOfBusinessObjectQueryLineOfBusiness.getAttributeTypeMap = function () {
        return QueryLineOfBusinessObjectQueryLineOfBusiness.attributeTypeMap;
    };
    QueryLineOfBusinessObjectQueryLineOfBusiness.discriminator = undefined;
    QueryLineOfBusinessObjectQueryLineOfBusiness.attributeTypeMap = [
        {
    ...
    return QueryLineOfBusinessObjectQueryLineOfBusiness;
}());
exports.QueryLineOfBusinessObjectQueryLineOfBusiness = QueryLineOfBusinessObjectQueryLineOfBusiness;
