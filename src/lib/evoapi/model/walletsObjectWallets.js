...
exports.WalletsObjectWallets = void 0;
var WalletsObjectWallets = /** @class */ (function () {
    function WalletsObjectWallets() {
    }
    WalletsObjectWallets.getAttributeTypeMap = function () {
        return WalletsObjectWallets.attributeTypeMap;
    };
    WalletsObjectWallets.discriminator = undefined;
    WalletsObjectWallets.attributeTypeMap = [
        {
    ...
    return WalletsObjectWallets;
}());
exports.WalletsObjectWallets = WalletsObjectWallets;
