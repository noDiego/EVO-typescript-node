...
export class OrderInitialObjectOrderInitial {
    /**
    ...
    */
    'currencyCode'?: OrderInitialObjectOrderInitial.CurrencyCodeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "OrderInitialObjectOrderInitial.CurrencyCodeEnum"
        },
        {
            "name": "amount",
            "baseName": "Amount",
    ...
    static getAttributeTypeMap() {
        return OrderInitialObjectOrderInitial.attributeTypeMap;
    }
}

export namespace OrderInitialObjectOrderInitial {
