...
export class KeepAliveResponseObjectKeepAliveResponse {
    /**
    ...
    */
    'responseActions': Array<KeepAliveResponseObjectKeepAliveResponse.ResponseActionsEnum>;
    /**
    ...
    */
    'wasReversePrevious'?: KeepAliveResponseObjectKeepAliveResponse.WasReversePreviousEnum;
    /**
    * Flag indicador de cancelación o confirmación del último bloque de transacciones, previo al nuevo valor recibido
    */
    'wasClosedPreviousBlock'?: KeepAliveResponseObjectKeepAliveResponse.WasClosedPreviousBlockEnum;
    /**
...
export namespace KeepAliveResponseObjectKeepAliveResponse {
