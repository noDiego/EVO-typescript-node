...
* Datos del vendedor
*/
export class SaleObjectSaleSeller {
    /**
    ...
    */
    'identificationType'?: SaleObjectSaleSeller.IdentificationTypeEnum;
    /**
    * Email del Vendedor
    */
    'email'?: string;
    ...
    * Tipo de documento del Vendedor. CI, Cédula de identidad - PAS, Pasaporte, Documento nacional de identidad, Contrato - CONTRACT, Número de Cuenta - ACCOUNT_NUMBER
    */
    'documentType'?: SaleObjectSaleSeller.DocumentTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "SaleObjectSaleSeller.IdentificationTypeEnum"
        },
        {
            "name": "email",
            "baseName": "Email",
        ...
        },
        {
            ...
            "type": "SaleObjectSaleSeller.DocumentTypeEnum"
        },
        {
            "name": "documentNumber",
    ...
    static getAttributeTypeMap() {
        return SaleObjectSaleSeller.attributeTypeMap;
    }
}

export namespace SaleObjectSaleSeller {
