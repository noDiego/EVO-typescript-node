...
exports.QueryCompaniesObjectQueryCompanies = void 0;
var QueryCompaniesObjectQueryCompanies = /** @class */ (function () {
    function QueryCompaniesObjectQueryCompanies() {
    }
    QueryCompaniesObjectQueryCompanies.getAttributeTypeMap = function () {
        return QueryCompaniesObjectQueryCompanies.attributeTypeMap;
    };
    QueryCompaniesObjectQueryCompanies.discriminator = undefined;
    QueryCompaniesObjectQueryCompanies.attributeTypeMap = [
        {
        ...
        {
            "name": "lineOfBusinessIdentification",
            "baseName": "LineOfBusinessIdentification",
            "type": "string"
        },
        {
    ...
    return QueryCompaniesObjectQueryCompanies;
}());
exports.QueryCompaniesObjectQueryCompanies = QueryCompaniesObjectQueryCompanies;
