...
exports.OrderStatusObjectOrderStatus = void 0;
var OrderStatusObjectOrderStatus = /** @class */ (function () {
    function OrderStatusObjectOrderStatus() {
    }
    OrderStatusObjectOrderStatus.getAttributeTypeMap = function () {
        return OrderStatusObjectOrderStatus.attributeTypeMap;
    };
    OrderStatusObjectOrderStatus.discriminator = undefined;
    OrderStatusObjectOrderStatus.attributeTypeMap = [
        {
        ...
        {
            "name": "reverseReason",
            "baseName": "ReverseReason",
            "type": "OrderStatusObjectOrderStatus.ReverseReasonEnum"
        },
        {
            "name": "reasonSequenceBreak",
            "baseName": "ReasonSequenceBreak",
            "type": "OrderStatusObjectOrderStatus.ReasonSequenceBreakEnum"
        },
        {
            "name": "reference",
            "baseName": "Reference",
        ...
        },
        {
            ...
            "type": "OrderStatusObjectOrderStatus.CurrencyCodeEnum"
        },
        {
        ...
        },
        {
            ...
            "type": "OrderStatusObjectOrderStatus.CardReadModeEnum"
        },
        {
            "name": "cardNumber",
            "baseName": "CardNumber",
    ...
    return OrderStatusObjectOrderStatus;
}());
exports.OrderStatusObjectOrderStatus = OrderStatusObjectOrderStatus;
(function (OrderStatusObjectOrderStatus) {
    var ReverseReasonEnum;
    (function (ReverseReasonEnum) {
        ReverseReasonEnum[ReverseReasonEnum["Timeout"] = 'TIMEOUT'] = "Timeout";
        ReverseReasonEnum[ReverseReasonEnum["ProcessingError"] = 'PROCESSING_ERROR'] = "ProcessingError";
        ReverseReasonEnum[ReverseReasonEnum["CardGenerated"] = 'CARD_GENERATED'] = "CardGenerated";
        ReverseReasonEnum[ReverseReasonEnum["Other"] = 'OTHER'] = "Other";
    })(ReverseReasonEnum = OrderStatusObjectOrderStatus.ReverseReasonEnum || (OrderStatusObjectOrderStatus.ReverseReasonEnum = {}));
    ...
    })(ReasonSequenceBreakEnum = OrderStatusObjectOrderStatus.ReasonSequenceBreakEnum || (OrderStatusObjectOrderStatus.ReasonSequenceBreakEnum = {}));
    ...
    })(CurrencyCodeEnum = OrderStatusObjectOrderStatus.CurrencyCodeEnum || (OrderStatusObjectOrderStatus.CurrencyCodeEnum = {}));
    ...
    })(CardReadModeEnum = OrderStatusObjectOrderStatus.CardReadModeEnum || (OrderStatusObjectOrderStatus.CardReadModeEnum = {}));
})(OrderStatusObjectOrderStatus = exports.OrderStatusObjectOrderStatus || (exports.OrderStatusObjectOrderStatus = {}));
exports.OrderStatusObjectOrderStatus = OrderStatusObjectOrderStatus;
