...
export class BlockCancelResponseObjectBlockCancelResponse {
    /**
    ...
    */
    'responseActions': Array<BlockCancelResponseObjectBlockCancelResponse.ResponseActionsEnum>;
    /**
    ...
    */
    'wasReversePrevious'?: BlockCancelResponseObjectBlockCancelResponse.WasReversePreviousEnum;
    /**
    * Flag indicador de cancelación o confirmación del último bloque de transacciones, previo al nuevo valor recibido
    */
    'wasClosedPreviousBlock'?: BlockCancelResponseObjectBlockCancelResponse.WasClosedPreviousBlockEnum;
    /**
...
export namespace BlockCancelResponseObjectBlockCancelResponse {
