...
exports.DebtInquiryResponseObjectDebtInquiryResponse = void 0;
var DebtInquiryResponseObjectDebtInquiryResponse = /** @class */ (function () {
    function DebtInquiryResponseObjectDebtInquiryResponse() {
    }
    DebtInquiryResponseObjectDebtInquiryResponse.getAttributeTypeMap = function () {
        return DebtInquiryResponseObjectDebtInquiryResponse.attributeTypeMap;
    };
    DebtInquiryResponseObjectDebtInquiryResponse.discriminator = undefined;
    DebtInquiryResponseObjectDebtInquiryResponse.attributeTypeMap = [
        {
            "name": "responseCode",
        ...
        },
        {
            ...
            "type": "Array<DebtInquiryResponseObjectDebtInquiryResponse.ResponseActionsEnum>"
        },
        {
        ...
        },
        {
            ...
            "type": "DebtInquiryResponseObjectDebtInquiryResponse.WasReversePreviousEnum"
        },
        {
        ...
        },
        {
            ...
            "type": "DebtInquiryResponseObjectDebtInquiryResponse.CurrencyCodeEnum"
        },
        {
        ...
        },
        {
            ...
            "type": "DebtInquiryResponseObjectDebtInquiryResponse.CardReadModeEnum"
        },
        {
            "name": "cardReadModeDescription",
            "baseName": "CardReadModeDescription",
            "type": "DebtInquiryResponseObjectDebtInquiryResponse.CardReadModeDescriptionEnum"
        },
        {
        ...
        {
            "name": "accountSummary",
            "baseName": "AccountSummary",
            "type": "DebtInquiryResponseObjectDebtInquiryResponseAccountSummary"
        },
        {
            "name": "debitAccountType",
            "baseName": "DebitAccountType",
            "type": "string"
        },
        {
            "name": "accountNumber",
        ...
        },
        {
            ...
            "baseName": "PaymentIdentification",
            "type": "string"
        },
        {
            "name": "fallbackForced",
            "baseName": "FallbackForced",
            "type": "DebtInquiryResponseObjectDebtInquiryResponse.FallbackForcedEnum"
        },
        {
            "name": "reversedPaymentIdentification",
            "baseName": "ReversedPaymentIdentification",
            "type": "string"
        },
        {
            "name": "wasClosedPreviousBlock",
            "baseName": "WasClosedPreviousBlock",
            "type": "DebtInquiryResponseObjectDebtInquiryResponse.WasClosedPreviousBlockEnum"
        },
        {
            "name": "identifierForTheAcquirer",
            "baseName": "IdentifierForTheAcquirer",
            "type": "string"
        },
        {
            "name": "companies",
            "baseName": "Companies",
            "type": "Array<DebtInquiryResponseObjectDebtInquiryResponseCompanies>"
        }
    ];
    return DebtInquiryResponseObjectDebtInquiryResponse;
}());
exports.DebtInquiryResponseObjectDebtInquiryResponse = DebtInquiryResponseObjectDebtInquiryResponse;
(function (DebtInquiryResponseObjectDebtInquiryResponse) {
    var ResponseActionsEnum;
    (function (ResponseActionsEnum) {
        ResponseActionsEnum[ResponseActionsEnum["Ok"] = 'OK'] = "Ok";
        ResponseActionsEnum[ResponseActionsEnum["Approve"] = 'Approve'] = "Approve";
        ResponseActionsEnum[ResponseActionsEnum["Refuse"] = 'Refuse'] = "Refuse";
        ResponseActionsEnum[ResponseActionsEnum["IssuerCall"] = 'IssuerCall'] = "IssuerCall";
        ResponseActionsEnum[ResponseActionsEnum["WithHold"] = 'WithHold'] = "WithHold";
        ResponseActionsEnum[ResponseActionsEnum["GetCard"] = 'GetCard'] = "GetCard";
        ResponseActionsEnum[ResponseActionsEnum["UseTerminalToAuthorize"] = 'UseTerminalToAuthorize'] = "UseTerminalToAuthorize";
        ResponseActionsEnum[ResponseActionsEnum["ConfigurationError"] = 'ConfigurationError'] = "ConfigurationError";
        ResponseActionsEnum[ResponseActionsEnum["SystemError"] = 'SystemError'] = "SystemError";
        ResponseActionsEnum[ResponseActionsEnum["ResourceError"] = 'ResourceError'] = "ResourceError";
        ResponseActionsEnum[ResponseActionsEnum["ProcessError"] = 'ProcessError'] = "ProcessError";
        ResponseActionsEnum[ResponseActionsEnum["EnableService"] = 'EnableService'] = "EnableService";
        ResponseActionsEnum[ResponseActionsEnum["Completed"] = 'Completed'] = "Completed";
        ResponseActionsEnum[ResponseActionsEnum["Configure"] = 'Configure'] = "Configure";
        ResponseActionsEnum[ResponseActionsEnum["Tickets"] = 'Tickets'] = "Tickets";
        ResponseActionsEnum[ResponseActionsEnum["Display"] = 'Display'] = "Display";
        ResponseActionsEnum[ResponseActionsEnum["Print"] = 'Print'] = "Print";
        ResponseActionsEnum[ResponseActionsEnum["Error"] = 'Error'] = "Error";
        ResponseActionsEnum[ResponseActionsEnum["Retry"] = 'Retry'] = "Retry";
        ResponseActionsEnum[ResponseActionsEnum["KeysRenewal"] = 'KeysRenewal'] = "KeysRenewal";
    })(ResponseActionsEnum = DebtInquiryResponseObjectDebtInquiryResponse.ResponseActionsEnum || (DebtInquiryResponseObjectDebtInquiryResponse.ResponseActionsEnum = {}));
    var WasReversePreviousEnum;
    (function (WasReversePreviousEnum) {
        WasReversePreviousEnum[WasReversePreviousEnum["NUMBER_0"] = 0] = "NUMBER_0";
        WasReversePreviousEnum[WasReversePreviousEnum["NUMBER_1"] = 1] = "NUMBER_1";
    })(WasReversePreviousEnum = DebtInquiryResponseObjectDebtInquiryResponse.WasReversePreviousEnum || (DebtInquiryResponseObjectDebtInquiryResponse.WasReversePreviousEnum = {}));
    var CurrencyCodeEnum;
    (function (CurrencyCodeEnum) {
        CurrencyCodeEnum[CurrencyCodeEnum["_152"] = '152'] = "_152";
        CurrencyCodeEnum[CurrencyCodeEnum["_484"] = '484'] = "_484";
        CurrencyCodeEnum[CurrencyCodeEnum["_878"] = '878'] = "_878";
        CurrencyCodeEnum[CurrencyCodeEnum["_840"] = '840'] = "_840";
        CurrencyCodeEnum[CurrencyCodeEnum["_858"] = '858'] = "_858";
        CurrencyCodeEnum[CurrencyCodeEnum["_986"] = '986'] = "_986";
        CurrencyCodeEnum[CurrencyCodeEnum["Clp"] = 'CLP'] = "Clp";
        CurrencyCodeEnum[CurrencyCodeEnum["Mxn"] = 'MXN'] = "Mxn";
        CurrencyCodeEnum[CurrencyCodeEnum["Eur"] = 'EUR'] = "Eur";
        CurrencyCodeEnum[CurrencyCodeEnum["Usd"] = 'USD'] = "Usd";
        CurrencyCodeEnum[CurrencyCodeEnum["Uyu"] = 'UYU'] = "Uyu";
        CurrencyCodeEnum[CurrencyCodeEnum["Brl"] = 'BRL'] = "Brl";
    })(CurrencyCodeEnum = DebtInquiryResponseObjectDebtInquiryResponse.CurrencyCodeEnum || (DebtInquiryResponseObjectDebtInquiryResponse.CurrencyCodeEnum = {}));
    var CardReadModeEnum;
    (function (CardReadModeEnum) {
        CardReadModeEnum[CardReadModeEnum["C"] = 'C'] = "C";
        CardReadModeEnum[CardReadModeEnum["B"] = 'B'] = "B";
        CardReadModeEnum[CardReadModeEnum["M"] = 'M'] = "M";
        CardReadModeEnum[CardReadModeEnum["L"] = 'L'] = "L";
        CardReadModeEnum[CardReadModeEnum["S"] = 'S'] = "S";
        CardReadModeEnum[CardReadModeEnum["T"] = 'T'] = "T";
        CardReadModeEnum[CardReadModeEnum["E"] = 'E'] = "E";
        CardReadModeEnum[CardReadModeEnum["F"] = 'F'] = "F";
        CardReadModeEnum[CardReadModeEnum["K"] = 'K'] = "K";
        CardReadModeEnum[CardReadModeEnum["R"] = 'R'] = "R";
    })(CardReadModeEnum = DebtInquiryResponseObjectDebtInquiryResponse.CardReadModeEnum || (DebtInquiryResponseObjectDebtInquiryResponse.CardReadModeEnum = {}));
    var CardReadModeDescriptionEnum;
    (function (CardReadModeDescriptionEnum) {
        CardReadModeDescriptionEnum[CardReadModeDescriptionEnum["EmvChip"] = 'EMV CHIP'] = "EmvChip";
        CardReadModeDescriptionEnum[CardReadModeDescriptionEnum["MagneticStripe"] = 'MAGNETIC STRIPE'] = "MagneticStripe";
        CardReadModeDescriptionEnum[CardReadModeDescriptionEnum["Manual"] = 'MANUAL'] = "Manual";
        CardReadModeDescriptionEnum[CardReadModeDescriptionEnum["Contactless"] = 'CONTACTLESS'] = "Contactless";
        CardReadModeDescriptionEnum[CardReadModeDescriptionEnum["ContactlessStripe"] = 'CONTACTLESS STRIPE'] = "ContactlessStripe";
        CardReadModeDescriptionEnum[CardReadModeDescriptionEnum["Typed"] = 'TYPED'] = "Typed";
        CardReadModeDescriptionEnum[CardReadModeDescriptionEnum["Ecommerce"] = 'ECOMMERCE'] = "Ecommerce";
        CardReadModeDescriptionEnum[CardReadModeDescriptionEnum["Fallback"] = 'FALLBACK'] = "Fallback";
        CardReadModeDescriptionEnum[CardReadModeDescriptionEnum["Recurring"] = 'RECURRING'] = "Recurring";
    })(CardReadModeDescriptionEnum = DebtInquiryResponseObjectDebtInquiryResponse.CardReadModeDescriptionEnum || (DebtInquiryResponseObjectDebtInquiryResponse.CardReadModeDescriptionEnum = {}));
    var FallbackForcedEnum;
    (function (FallbackForcedEnum) {
        FallbackForcedEnum[FallbackForcedEnum["NUMBER_1"] = 1] = "NUMBER_1";
        FallbackForcedEnum[FallbackForcedEnum["NUMBER_0"] = 0] = "NUMBER_0";
    })(FallbackForcedEnum = DebtInquiryResponseObjectDebtInquiryResponse.FallbackForcedEnum || (DebtInquiryResponseObjectDebtInquiryResponse.FallbackForcedEnum = {}));
    var WasClosedPreviousBlockEnum;
    (function (WasClosedPreviousBlockEnum) {
        WasClosedPreviousBlockEnum[WasClosedPreviousBlockEnum["NUMBER_0"] = 0] = "NUMBER_0";
        WasClosedPreviousBlockEnum[WasClosedPreviousBlockEnum["NUMBER_1"] = 1] = "NUMBER_1";
    })(WasClosedPreviousBlockEnum = DebtInquiryResponseObjectDebtInquiryResponse.WasClosedPreviousBlockEnum || (DebtInquiryResponseObjectDebtInquiryResponse.WasClosedPreviousBlockEnum = {}));
})(DebtInquiryResponseObjectDebtInquiryResponse = exports.DebtInquiryResponseObjectDebtInquiryResponse || (exports.DebtInquiryResponseObjectDebtInquiryResponse = {}));
exports.DebtInquiryResponseObjectDebtInquiryResponse = DebtInquiryResponseObjectDebtInquiryResponse;
