...
exports.ReturnObjectReturn = void 0;
var ReturnObjectReturn = /** @class */ (function () {
    function ReturnObjectReturn() {
    }
    ReturnObjectReturn.getAttributeTypeMap = function () {
        return ReturnObjectReturn.attributeTypeMap;
    };
    ReturnObjectReturn.discriminator = undefined;
    ReturnObjectReturn.attributeTypeMap = [
        {
        ...
        },
        {
            ...
            "type": "ReturnObjectReturn.ReverseReasonEnum"
        },
        {
            "name": "reasonSequenceBreak",
            "baseName": "ReasonSequenceBreak",
            "type": "ReturnObjectReturn.ReasonSequenceBreakEnum"
        },
        {
            "name": "reference",
            "baseName": "Reference",
        ...
        },
        {
            ...
            "type": "ReturnObjectReturn.CurrencyCodeEnum"
        },
        {
        ...
        },
        {
            ...
            "type": "ReturnObjectReturn.CardReadModeEnum"
        },
        {
            "name": "cardGetMode",
        ...
        {
            "name": "origReference",
            "baseName": "OrigReference",
            "type": "string"
        },
        {
            "name": "origForeignBlock",
            "baseName": "OrigForeignBlock",
            "type": "string"
        },
        {
        ...
        {
            "name": "origMerchantID",
            "baseName": "OrigMerchantID",
            "type": "string"
        },
        {
            "name": "origTerminalID",
            "baseName": "OrigTerminalID",
            "type": "number"
        },
        {
            "name": "taxRefundType",
    ...
    return ReturnObjectReturn;
}());
exports.ReturnObjectReturn = ReturnObjectReturn;
(function (ReturnObjectReturn) {
    ...
    })(ReverseReasonEnum = ReturnObjectReturn.ReverseReasonEnum || (ReturnObjectReturn.ReverseReasonEnum = {}));
    ...
    })(ReasonSequenceBreakEnum = ReturnObjectReturn.ReasonSequenceBreakEnum || (ReturnObjectReturn.ReasonSequenceBreakEnum = {}));
    ...
    })(CurrencyCodeEnum = ReturnObjectReturn.CurrencyCodeEnum || (ReturnObjectReturn.CurrencyCodeEnum = {}));
    ...
    })(CardReadModeEnum = ReturnObjectReturn.CardReadModeEnum || (ReturnObjectReturn.CardReadModeEnum = {}));
})(ReturnObjectReturn = exports.ReturnObjectReturn || (exports.ReturnObjectReturn = {}));
exports.ReturnObjectReturn = ReturnObjectReturn;
