...
export class WalletRequestObjectWalletRequest {
    /**
    ...
    */
    'currencyCode'?: WalletRequestObjectWalletRequest.CurrencyCodeEnum;
    /**
...
export namespace WalletRequestObjectWalletRequest {
