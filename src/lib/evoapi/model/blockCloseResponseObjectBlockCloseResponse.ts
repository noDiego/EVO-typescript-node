...
export class BlockCloseResponseObjectBlockCloseResponse {
    /**
    ...
    */
    'responseActions': Array<BlockCloseResponseObjectBlockCloseResponse.ResponseActionsEnum>;
    /**
    ...
    */
    'wasReversePrevious'?: BlockCloseResponseObjectBlockCloseResponse.WasReversePreviousEnum;
    /**
    * Flag indicador de cancelación o confirmación del último bloque de transacciones, previo al nuevo valor recibido
    */
    'wasClosedPreviousBlock'?: BlockCloseResponseObjectBlockCloseResponse.WasClosedPreviousBlockEnum;
    /**
...
export namespace BlockCloseResponseObjectBlockCloseResponse {
